const CACHE='ai-health-karte-v110';
const ASSETS=['./','index.html','style.css?v=110','script.js?v=110','manifest.json','apple-touch-icon.png','icon-180.png','icon-192.png','icon-512.png'];
