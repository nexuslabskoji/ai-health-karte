const CACHE='ai-health-karte-v10-3-clockfix';
const ASSETS=['./','index.html','style.css?v=101','script.js?v=103','manifest.json','apple-touch-icon.png','icon-180.png','icon-192.png','icon-512.png'];
